  ...
  return (
    <section className="relative min-h-screen bg-zinc-900 py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        {/* Small embedded testimonial video (9:16) */}
        <div className="mt-10 flex justify-center">
          <div className="w-56 sm:w-64 md:w-72">
            <div className="relative aspect-[9/16] rounded-2xl overflow-hidden border border-white/15 bg-black shadow-[0_0_30px_rgba(0,0,0,0.35)]">
              <iframe
