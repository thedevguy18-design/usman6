      ...
      <section className="relative pt-40 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-white/60 text-lg md:text-xl max-w-2xl mx-auto">
            A curated showcase of our best video work — from AI-powered ads to explainer ads that drive real results.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 mt-10">
            {[
              ...
              { value: '2', label: 'Video Categories' },
            ].map((stat) => (
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-20">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {filtered.map((video) => (
              (video.category === 'AI Ads' || video.category === 'Explainer Ads') && video.videoUrl ? (
